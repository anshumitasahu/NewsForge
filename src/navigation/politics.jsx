...
export default function Politics() {
    ...
    useEffect(() => {
        fetch(`https://newsapi.org/v2/top-headlines?category=politics&apiKey=6097f6cb4ee845e38468604b491f2e0b&page=${page}&pageSize=8`)
    ...
    return (
        <>
            <div className="news-card">
                <h1 className='heading'>News Related To <span>Politics</span></h1>
                <div className="news-card">
